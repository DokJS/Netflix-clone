  ...
  return (
    ...
    <div className="w-full h-screen ">
      ...
      <div className='fixed w-full px-4 py-24 z-50'>
        ...
        <form className='flex flex-col py-4 space-y-6'>
          <input type="email" placeholder='email' autoComplete='email' className='p-3 bg-gray-600 rounded'/>
          <input type="password" placeholder='password' autoComplete='current-password' className='p-3 bg-gray-600 rounded'/>
